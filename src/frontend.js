...
const divsToUpdate = document.querySelectorAll(".simple-wp-quiz-update-me");

divsToUpdate.forEach(function (div) {
  const data = JSON.parse(div.querySelector("pre").innerHTML);
  ReactDOM.render(<Quiz {...data} />, div);
  div.classList.remove("simple-wp-quiz-update-me");
});
...
function Quiz(props) {
  ...
  return (
    <div
      className="simple-wp-quiz-frontend"
      style={{ backgroundColor: props.bgColor, textAlign: props.theAligment }}
    >
      <p>{props.question}</p>
      <ul>
